...
<%@ Import Namespace="Library.Config" %>
<%@ Import Namespace="Library.Security" %>
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        Thumbnails.MaxWidth = ConfigImage.WidthImageThumb;
        Thumbnails.MaxHeight = ConfigImage.HeightImageThumb;
